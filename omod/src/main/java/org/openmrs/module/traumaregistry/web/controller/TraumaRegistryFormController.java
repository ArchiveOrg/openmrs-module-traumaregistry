 ...
 */
package org.openmrs.module.traumaregistry.web.controller;
 ...
 * 'module/traumaregistry/traumaregistryLink.form'.
 */
@Controller
@RequestMapping(value = "module/traumaregistry/traumaregistryLink.form")
public class TraumaRegistryFormController {
	
	/** Logger for this class and subclasses */
	protected final Log log = LogFactory.getLog(getClass());
	
	/** Success form view name */
	private final String SUCCESS_FORM_VIEW = "/module/traumaregistry/traumaregistryForm";
